...
def Usage():
    ...
    pkg_group = parser.add_argument_group(' build, expand, export install pkg for chain.')
    ...
    pkg_group.add_argument('--expand', nargs='+', metavar=('./config.conf, dir with genesis.json bootstrapsnode.json fisco-bcos'),
    ...
    mgr_group = parser.add_argument_group(
        ' manage the published chain with ansible.')
    ...
    tools_group.add_argument('--chainca', nargs=1, metavar=('./dir_chain_ca(SET)',),
                        help='generate root cert')
    tools_group.add_argument('--agencyca', nargs=3, metavar=('./dir_agency_ca(SET)',
                                                        './chain_ca_dir', 'Agency_Name'), help='generate agency cert')
    tools_group.add_argument('--nodeca', nargs=3, metavar=('./dir_agency_ca(SET)',
                                                      './dir_node_ca', 'node_name'), help='generate node cert')
    tools_group.add_argument('--sdkca', nargs=2, metavar=('./dir_sdk_ca(SET)',
